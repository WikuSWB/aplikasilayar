                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="/insertdata" method="POST">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-12">
                                            <select class="form-select" aria-label="Default select example" name="tipe_surat" required>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Masukkan No KK"name="no_kk" id="inputnokk5s" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="inputnamaayah5" class="form-label">Nama Ayah Kandung</label>
                                        <input type="text" class="form-control" placeholder="Masukkan Nama Ayah Kandung" name="nama_ayah" id="inputnamayah5s" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="inputnamaibu5" class="form-label">Nama Ibu Kandung</label>
                                        <input type="text" class="form-control" placeholder="Masukkan Nama Ibu Kandung" name="nama_ibu"id="inputnamaibu5s" required>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <label for="inputpendidikan5" class="form-label" name="pendidikan_terakhir">Pendidikan Terakhir</label>
                                        <select id="inputpendidikan5" class="form-select"name="pendidikan_terakhir" required>
                                            <option selected>Pilih Salah Satu...</option>
                                            <option value="Tidak / Belum Sekolah">Tidak / Belum Sekolah</option>
                                            <option value="SD">SD</option>
                                            <option value="SMP">SMP</option>
                                            <option value="SMA / SMK">SMA / SMK</option>
                                            <option value="Diploma 3 (D3)">Diploma Tiga (D3)</option>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>Berikut Tutorial Video Pembuatan Pengajuan Surat</p>


                                <div class="col-sm-12 col-md-8 offset-lg-2 align-self-centre text-centre">
                                    <div class="card-youtube">
                                        <div class="iframe-container">
                                            <iframe width="560" height="315" src="https://www.youtube.com/embed/qfKcQlOzGW0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
