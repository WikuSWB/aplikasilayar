                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <p></p>
                                <img src="{{asset('dashboard_asset/assets/img/bantuan.svg')}}" alt="bantuan" class="gambar-bantuan">
                            </div>

                            <div class="card-body">
                                <h2 class="card-title-bantuan">Mengalami Masalah ?</h2>
                                <div style="text-align:center;">
                                    <p>Butuh Bantuan Untuk Mengurus Administrasi ?
                                        Hubungi Kami
                                    </p>
                                </div>
                                ...
                                <div class="btn-link-wa">
                                    <a href=" https://wa.me/6281378792900?text=Saya%20ingin%20meminta%20bantuan%20dalam%20penggunaan%20Aplikasi%20Layar.">
                                        <button type="button" class="btn btn-linked" style="width: 186px;height: 40px;"><i class="bi bi-whatsapp"></i> 0813-7879-2900</button></a>
                                </div>
                                ...
                                <h2 class="card-title-hubungi"><a href="mailto:hubungi.layar@gmail.com?subject=Bantuan%20Apikasi%20LAYAR">hubungi.layar@gmail.com</a></h2>
