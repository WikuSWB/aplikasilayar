...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav " id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapased" href="{{ route('bantuan') }}">
           ...
           <!-- Default Card -->
              ...
              <tbody>
                    <tr>
                      ...
                      <td>Muhammad Desrial Ramadhan</td>
                      <td>14/12/2022</td>
                    ...
                    <tr>
                      ...
                      <td>Wikusangker Wirabumi</td>
                      <td>14/12/2022</td>
                      <td>Surat Pemubuatan SKCK</td>
                      <td><span class="badge bg-success">Disetujui</span></td>
                      <td> 
                        <button type="button"  class="btn btn-secondary btn-sm"><i class="bi bi-file-text"></i> Lihat Dokumen</button></td>
